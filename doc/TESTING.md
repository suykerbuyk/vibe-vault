...
**1843 tests** across 50 test packages + **1 integration test** (31 subtests) + **21 vault-accessor integration tests** + **5 wrap-dispatch integration tests**. All passing.
